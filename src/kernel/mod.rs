...
use syscalls::Sysno;
use thiserror::Error;
use yaxpeax_x86::{amd64::Opcode, long_mode::Operand};
    ...
    pub fn execute(&mut self, executable: &Executable) -> Result<u64> {
        ...
        if active_instruction_block.is_executable() {
            ...
            loop {
                ...
                match active_instruction.opcode() {
                    ...
                    // Opcode::LEAVE => todo!(),
                    Opcode::MOV => {
                        let to_move = read_operand(&registers, active_instruction.operand(1));
                        write_target(&mut registers, active_instruction.operand(0), to_move);
                    }
                    // Opcode::RETURN => todo!(),
                    // Opcode::PUSHF => todo!(),
                    // Opcode::WAIT => todo!(),
                    ...
                    _ => {
                        ...
                        panic!("Unimplemented instruction: {}", active_instruction);
                    }
                }
            }
        } else {
